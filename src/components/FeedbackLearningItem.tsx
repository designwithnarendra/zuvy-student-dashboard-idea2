...
interface FeedbackLearningItemProps {
  item: {
    title: string;
    description: string;
  };
...
const FeedbackLearningItem = ({ item }: FeedbackLearningItemProps) => {
        ...
        <div className="space-y-3">
          ...
          >
            {['Excellent', 'Good', 'Average', 'Poor'].map((option, index) => (
              <div key={index} className="flex items-center space-x-2" style={{ padding: '16px 0' }}>
...
export default FeedbackLearningItem;

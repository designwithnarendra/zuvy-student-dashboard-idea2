          ...
          <div className="mb-4">
            ...
            <div className="flex gap-2 mb-4">
              <span className={`px-2 py-1 rounded text-xs font-medium ${
                challenge.difficulty === 'Easy' ? 'bg-success text-success-foreground' :
                challenge.difficulty === 'Medium' ? 'bg-warning text-warning-foreground' :
          ...
          <div className="flex-1 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Button 
                ...
                disabled={!testsPass || isSubmitted}
